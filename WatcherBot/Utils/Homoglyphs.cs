...
public static class Homoglyphs
{
    ...
    private static readonly ImmutableHashSet<ImmutableHashSet<uint>> homoglyphs = new [] {
        ...
        new uint[]{0x2a600,0x2fa1d},
            // @formatter:on
        }.Select(a => a.ToImmutableHashSet())
         .ToImmutableHashSet();

    private static readonly ImmutableDictionary<uint, ImmutableHashSet<uint>> CharToHomoglyphGroup = homoglyphs
        .SelectMany(g => g.Select(c => new KeyValuePair<uint, ImmutableHashSet<uint>>(c, g)))
